...
def segment_document():
    ...
    try:
        ...
        # 4. Refine each initially found document
        all_final_docs = []
        ...
        # 5. Encode the final documents into Base64 for the JSON response
        encoded_documents = []
        ...
        print(f"Request complete. Returning {len(encoded_documents)} documents.")
        return jsonify({"status": "success", "documents": encoded_documents})
